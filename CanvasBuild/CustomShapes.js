    ...
    static initalizeSequenceFeatureShape() {
        ...
        SequenceFeatureShape.prototype.init = function (container) {
            ...
            if (this.state != null && this.state.cell.isSequenceFeatureGlyph()) {
                this.composite = new graph_base_js_1.mx.mxShape(graph_base_js_1.mx.mxStencilRegistry.getStencil("composite"));
                this.composite.dialect = this.dialect;
                this.composite.init(this.node);
                this.variant = new graph_base_js_1.mx.mxShape(graph_base_js_1.mx.mxStencilRegistry.getStencil("variant"));
                this.variant.dialect = this.dialect;
                this.variant.init(this.node);
                this.error = new graph_base_js_1.mx.mxShape(graph_base_js_1.mx.mxStencilRegistry.getStencil("error"));
