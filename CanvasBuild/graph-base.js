...
class GraphBase {
    ...
    initDecodeEnv() {
        ...
        Object.defineProperty(glyphInfo_js_1.GlyphInfo, "name", { configurable: true, value: "GlyphInfo" });
        ...
        Object.defineProperty(moduleInfo_js_1.ModuleInfo, "name", { configurable: true, value: "ModuleInfo" });
        ...
        Object.defineProperty(interactionInfo_js_1.InteractionInfo, "name", { configurable: true, value: "InteractionInfo" });
        const interactionInfoCodec = new exports.mx.mxObjectCodec(new interactionInfo_js_1.InteractionInfo());
        ...
        Object.defineProperty(combinatorialInfo_js_1.CombinatorialInfo, "name", { configurable: true, value: "CombinatorialInfo" });
        const combinatorialInfoCodec = new exports.mx.mxObjectCodec(new combinatorialInfo_js_1.CombinatorialInfo());
        ...
        Object.defineProperty(variableComponentInfo_js_1.VariableComponentInfo, "name", { configurable: true, value: "VariableComponentInfo" });
        const variableComponentInfoCodec = new exports.mx.mxObjectCodec(new variableComponentInfo_js_1.VariableComponentInfo());
        ...
        Object.defineProperty(identifiedInfo_js_1.IdentifiedInfo, "name", { configurable: true, value: "IdentifiedInfo" });
        const identifiedInfoCodec = new exports.mx.mxObjectCodec(new identifiedInfo_js_1.IdentifiedInfo());
        ...
        // canvas annotation
        Object.defineProperty(canvasAnnotation_js_1.CanvasAnnotation, "name", { configurable: true, value: "CanvasAnnotation" });
        const canvasAnnotationCodec = new exports.mx.mxObjectCodec(new canvasAnnotation_js_1.CanvasAnnotation());
        ...
        exports.mx.mxCodec.prototype.decodeCell = function (node, restoreStructures) {
            ...
            if (reconstructCellStyle) {
                if (glyphDict[cell.value] != null) {
                    ...
                    else if (glyphDict[cell.value] instanceof glyphInfo_js_1.GlyphInfo && glyphDict[cell.value].partType === 'DNA region') {
                        // sequence feature
                        if (!cell.style) {
    ...
    initExtraCellMethods() {
        ...
        exports.mx.mxCell.prototype.refreshCircuitContainer = function (graph) {
            ...
            this.replaceGeometry('auto', 'auto', this.getBackbone().getGeometry().width, GraphBase.sequenceFeatureGlyphHeight, graph);
    ...
    initStyles() {
        ...
        this.baseMolecularSpeciesGlyphStyle[exports.mx.mxConstants.STYLE_VERTICAL_LABEL_POSITION] = 'bottom';
        ...
        this.baseSequenceFeatureGlyphStyle = exports.mx.mxUtils.clone(this.baseMolecularSpeciesGlyphStyle);
        this.baseSequenceFeatureGlyphStyle[exports.mx.mxConstants.STYLE_PORT_CONSTRAINT] = [exports.mx.mxConstants.DIRECTION_NORTH, exports.mx.mxConstants.DIRECTION_SOUTH];
        this.baseInteractionNodeGlyphStyle = exports.mx.mxUtils.clone(this.baseMolecularSpeciesGlyphStyle);
        const textBoxStyle = {};
        ...
        circuitContainerStyle[exports.mx.mxConstants.STYLE_SHAPE] = exports.mx.mxConstants.SHAPE_RECTANGLE;
        ...
        circuitContainerStyle[exports.mx.mxConstants.STYLE_PORT_CONSTRAINT] = [exports.mx.mxConstants.DIRECTION_NORTH, exports.mx.mxConstants.DIRECTION_SOUTH];
        ...
        baseInteractionGlyphStyle[exports.mx.mxConstants.STYLE_EDGE] = exports.mx.mxConstants.EDGESTYLE_ORTHOGONAL;
        ...
        interactionControlStyle[exports.mx.mxConstants.STYLE_ENDARROW] = exports.mx.mxConstants.ARROW_DIAMOND;
        ...
        interactionInhibitionStyle[exports.mx.mxConstants.STYLE_ENDARROW] = GraphBase.interactionInhibitionName;
        ...
        interactionStimulationStyle[exports.mx.mxConstants.STYLE_ENDARROW] = exports.mx.mxConstants.ARROW_BLOCK;
        ...
        interactionProcessStyle[exports.mx.mxConstants.STYLE_ENDARROW] = exports.mx.mxConstants.ARROW_BLOCK;
        ...
        interactionDegradationStyle[exports.mx.mxConstants.STYLE_ENDARROW] = GraphBase.interactionDegradationName;
    ...
    initCustomShapes() {
        ...
        exports.mx.mxMarker.addMarker(GraphBase.interactionDegradationName, degradationMarkerDrawFunction);
    ...
    initListeners() {
        // edge movement
        this.graph.addListener(exports.mx.mxEvent.CONNECT_CELL, exports.mx.mxUtils.bind(this, function (sender, evt) {
        ...
        // cell movement
        this.graph.addListener(exports.mx.mxEvent.MOVE_CELLS, exports.mx.mxUtils.bind(this, function (sender, evt) {
            return __awaiter(this, void 0, void 0, function* () {
                // sender is the graph
                sender.getModel().beginUpdate();
                let cancelled = false;
                try {
                    ...
                    if (sender.getCurrentRoot()) {
                        ...
                        for (let container of Array.from(containers.values())) {
                            ...
                            if (ownershipChange && glyphInfo.uriPrefix != environment_js_1.environment.baseURI && !(yield this.promptMakeEditableCopy(glyphInfo.displayID))) {
                                cancelled = true;
