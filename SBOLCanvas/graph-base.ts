...
export class GraphBase {
  ...
  initDecodeEnv() {
    ...
    Object.defineProperty(InteractionInfo, 'name', {
      configurable: true,
    ...
    Object.defineProperty(CombinatorialInfo, 'name', {
      configurable: true,
    ...
    Object.defineProperty(VariableComponentInfo, 'name', {
      configurable: true,
    ...
    // canvas annotation
    Object.defineProperty(CanvasAnnotation, 'name', {
      configurable: true,
      ...
      if (reconstructCellStyle) {
        if (glyphDict[cell.value] != null) {
          if (glyphDict[cell.value] instanceof ModuleInfo) {
            ...
            glyphDict[cell.value] instanceof GlyphInfo &&
  ...
  initStyles() {
    ...
    this.baseSequenceFeatureGlyphStyle[mx.mxConstants.STYLE_PORT_CONSTRAINT] = [
      mx.mxConstants.DIRECTION_NORTH,
      mx.mxConstants.DIRECTION_SOUTH,
    ]
    ...
    circuitContainerStyle[mx.mxConstants.STYLE_PORT_CONSTRAINT] = [
      mx.mxConstants.DIRECTION_NORTH,
      mx.mxConstants.DIRECTION_SOUTH,
    ]
    this.graph
    ...
    interactionDegradationStyle[mx.mxConstants.STYLE_ENDARROW] =
  ...
  initListeners() {
    ...
    this.graph.addListener(
      mx.mxEvent.CONNECT_CELL,
      mx.mxUtils.bind(this, async function (sender, evt) {
  ...
  protected validateInteraction(
    interactionType: string,
    source: typeof mxCell,
    target: typeof mxCell
  ) {
